...
//   });
//
//   it('should create FETCH_TABLE_REQUEST && FETCH_TABLE_SUCCESS if table is defined
// in store but it is previously requestFailed', () => {
//     const store = mockStore(initializedState);
//     const expectedActions = [
//       {
...
//   });
//
//   it('should create FETCH_TABLE_REQUEST && FETCH_TABLE_
// SUCCESS if table is not defined in store', () => {
//     const store = mockStore(initializedState);
//     const expectedActions = [
//       {
//         type: types.FETCH_TABLE_REQUEST,
...
//     Date.now = jest.fn(() => 1000);
//
//     nock(`https:${config.apiRoot}`).get('/competitio
// ns/5/leagueTable?matchday=1').replyWithError({
//       message: 'Some Error',
//       code: 'AWFUL_ERROR',
//       statusCode: '500',
//     });
