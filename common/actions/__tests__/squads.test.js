...
//   });
//
//   it('should create FETCH_SQUAD_REQUEST && FETCH_SQUAD_SUCCESS if squad
// is defined in store but it is previously requestFailed', () => {
//     const store = mockStore(initializedState);
//     const expectedActions = [
//       {
...
//   });
//
//   it('should create FETCH_SQUAD_REQUEST && FETCH_S
// QUAD_SUCCESS if squad is not defined in store', () => {
//     const store = mockStore(initializedState);
//     const expectedActions = [
//       {
//         type: types.FETCH_SQUAD_REQUEST,
