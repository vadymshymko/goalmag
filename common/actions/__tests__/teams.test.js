...
describe('teams actions', () => {
  ...
  it('should create FETCH_TEAM_REQUEST && FETCH_TEAM_SUCCESS if team is defined in store but it is previously requestFailed', () => {
    const store = mockStore(initializedState);
    const expectedActions = [
      {
  ...
  it('should create FETCH_TEAM_REQUEST && FETCH_TEAM_SUCCESS if team is not defined in store', () => {
    const store = mockStore(initializedState);
    const expectedActions = [
      {
        type: types.FETCH_TEAM_REQUEST,
